    ...
    <main className="site-main">
      <section className="about">
        ...
        <div className='about__text'>
          ...
          <p>
            Hi! My name is Khan, and I am a published full-stack developer. I primarily make games and I have a lifelong passion for graphic design from my background as a 3D artist.
          </p>
